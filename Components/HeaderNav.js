        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className={"mx-auto gap-5 " + style.nav_bar}>
              <Link href='/'><Nav.Link href="/">Portofolio</Nav.Link></Link>
              <Link href='/gallery'><Nav.Link href="/gallery">Gallery</Nav.Link></Link>
              <Link href='/about'><Nav.Link href="/about">Contact</Nav.Link></Link>
            </Nav>
          </Navbar.Collapse>
        </Container>
      </Navbar>     
